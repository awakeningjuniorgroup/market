...
const AdminHomePage = () => {
  ...
  const renderError = (error) => {
    ...
    return typeof error === "object" ? error.message || "Erreur inconnue" : error;
  };
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      {productsError && (
        <p className="text-red-500">Error fetching products: {renderError(productsError)}</p>
      )}
      {ordersError && (
        <p className="text-red-500">Error fetching orders: {renderError(ordersError)}</p>
      )}
