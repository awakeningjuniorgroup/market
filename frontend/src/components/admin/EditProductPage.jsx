...
import { fetchProductDetails, updateProduct } from "../../../slice/productsSlice";
...
const EditProductPage = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    const formData = new FormData(); // ✅ majuscule
    formData.append("image", file);

    try {
      setUploading(true);
      const { data } = await api.post("/upload", formData, {
        headers: { "Content-Type": "multipart/form-data" }, // ✅ correction
      });
